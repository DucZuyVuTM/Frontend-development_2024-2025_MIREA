...
// @todo: Card Delete Function

// @todo: Display cards on page

const popups = document.querySelectorAll('.popup'); // add animations for popups
...
profileEditButton = document.querySelector('.profile__edit-button'); // profile
...
profileAddButton = document.querySelector('.profile__add-button'); // adding pics
...
// with cards (Adding a custom one)
const cardTemplate = document.querySelector("#template").content;

function createCard(link, name) {
  const curCard = cardTemplate.querySelector('.places__item').cloneNode(true); // copy pics
  curCard.querySelector('.card__image').src = link;
  curCard.querySelector('.card__description').querySelector('.card__title').textContent = name; // choose and add a caption
